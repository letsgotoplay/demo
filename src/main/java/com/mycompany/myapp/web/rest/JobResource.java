...
public class JobResource {
    ...
    private static final String ENTITY_NAME = "demoJob";
    ...
    public List<Job> searchJobs(@RequestParam String query) {
        ...
        return StreamSupport.stream(jobSearchRepository.search(query).spliterator(), false).collect(Collectors.toList());
    }
}
